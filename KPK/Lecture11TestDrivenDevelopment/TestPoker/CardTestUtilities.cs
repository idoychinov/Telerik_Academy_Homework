...
namespace TestPoker
{
    ...
    public static class CardTestUtilities
    {
        ...
        /// </summary>
        public static readonly IDictionary<IHand, HandCategory> AllHandsAndTypes = GenerateAllHandsAndTypes();
        ...
        private static IDictionary<IHand, HandCategory> GenerateAllHandsAndTypes()
        {
