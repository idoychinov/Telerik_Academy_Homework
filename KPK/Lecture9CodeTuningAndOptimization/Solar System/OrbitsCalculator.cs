...
namespace SolarSystem
{
    class OrbitsCalculator : INotifyPropertyChanged
    {
        ...
        {
            // Removed unnecesery cycle that was beeing called over 7 milion times per EarthRotation() function call and was not doing anything
            // the end result from the cycle was EarthRotationAngle = 360 * Days / EarthRotationPeriod; After replacing it with this the performance
            // jumped from 12.5% CPU utilization (on i7 processor...) to 0%  CPU utilization.
