...
namespace MyIO
{
    public class MyIOClass
    {
        ...
        public void Input(out byte output, string defaultInMessage = inMessageStart + "(0..255): ", string defautErrMessage = ErrMessage)
        {
            string inValue;
        ...
        public void Input(out sbyte output, string defaultInMessage = inMessageStart + "(-128..127): ", string defautErrMessage = ErrMessage)
        {
            string inValue;
            Console.Write(defaultInMessage);
            while (true)
        ...
        public void Input(out short output, string defaultInMessage = inMessageStart + "(-32,768..32,767): ", string defautErrMessage = ErrMessage)
        {
            string inValue;
            Console.Write(defaultInMessage);
            while (true)
        ...
        public void Input(out ushort output, string defaultInMessage = inMessageStart + "(0 .. 65,535): ", string defautErrMessage = ErrMessage)
        {
            string inValue;
            Console.Write(defaultInMessage);
            while (true)
        ...
        public void Input(out int output, string defaultInMessage = inMessageStart + "(-2,147,483,648 .. 2,147,483,647): ", string defautErrMessage = ErrMessage)
        {
            string inValue;
            Console.Write(defaultInMessage);
            while (true)
        ...
        public void Input(out uint output, string defaultInMessage = inMessageStart + "(0 .. 4,294,967,295): ", string defautErrMessage = ErrMessage)
        {
            string inValue;
            Console.Write(defaultInMessage);
            while (true)
        ...
        public void Input(out long output, string defaultInMessage = inMessageStart + "(-9,223,372,036,854,775,808 .. 9,223,372,036,854,775,807): ", string defautErrMessage = ErrMessage)
        {
            string inValue;
            Console.Write(defaultInMessage);
            while (true)
        ...
        public void Input(out ulong output, string defaultInMessage = inMessageStart + "(0 .. 18,446,744,073,709,551,615): ", string defautErrMessage = ErrMessage)
        {
            string inValue;
            Console.Write(defaultInMessage);
            while (true)
        ...
        public void Input(out float output, string defaultInMessage = inMessageStart + "(-3.402823e38 .. 3.402823e38): ", string defautErrMessage = ErrMessage)
        {
            string inValue;
            Console.Write(defaultInMessage);
            while (true)
        ...
        public void Input(out double output, string defaultInMessage = inMessageStart + "(-1.79769313486232e308 .. 1.79769313486232e308): ", string defautErrMessage = ErrMessage)
        {
            string inValue;
            Console.Write(defaultInMessage);
            while (true)
        ...
        public void Input(out decimal output, string defaultInMessage = inMessageStart + "(-79228162514264337593543950335 .. 79228162514264337593543950335): ", string defautErrMessage = ErrMessage)
        {
            string inValue;
            Console.Write(defaultInMessage);
            while (true)
